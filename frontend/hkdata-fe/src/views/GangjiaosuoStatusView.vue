...
const statsData = reactive({
  ...
  time: '2025年Q1',
  coreMetrics: [
    { icon: TrendCharts, value: '+11.9%', desc: '股票年化增长率', time: '2020年5月-2025年5月' },
    { icon: PieChart, value: '63.28亿', desc: '营收', time: '2025年Q1' },
    { icon: Coin, value: '37.62亿', desc: '自由现金流', time: '2025年Q1' },
    { icon: PriceTag, value: '480港币', desc: '公允价值-DCF分析', time: '5年' }
  ],
  revenueFcf: {
    x: ['2020', '2021', '2022', '2023', '2024'],
    revenue: [161, 171, 164.9, 185.9, 207.2],
    fcf: [97, 102, 90, 107.5, 120.8]
  },
  revenueSource: [
    { value: 53, name: '现货市场', color: '#e74c3c' },
    { value: 27, name: '衍生品市场', color: '#2986f7' },
    { value: 13, name: '固定收益及货币', color: '#f7d358' },
    { value: 7, name: '其他', color: '#6fcf97' }
  ],
  region: [
    { name: '香港', color: '#2986f7', size: 90, font: 28 },
    { name: '英国', color: '#3b5998', size: 70, font: 22 },
    { name: '内地', color: '#7b8dbb', size: 54, font: 18 },
    { name: '其他', color: '#111', size: 44, font: 16 }
  ],
  kpi: [
    { label: '日均成交额增长', percent: 100, value: '+153%', color: '#00B050' },
    { label: '南向资金净流入', percent: 100, value: '+4000亿', color: '#FFD600' },
    { label: '新股上市数量', percent: 100, value: '17家', color: '#00B050' }
  ],
  rating: [
  ...
  finance: [
    { label: '营收增长', percent: 34, value: '+34%', color: '#FFD600' },
    { label: '自由现金流FCF增长', percent: 40, value: '+40%', color: '#00B050' },
    { label: '现金及现金等价物', percent: 100, value: '128亿', color: '#2196f3' }
  ],
  pros: [
    { icon: CirclePlusFilled, text: '南向资金持续流入，市场活跃度再创新高。' },
    { icon: CirclePlusFilled, text: '创新产品线扩展，ETF和衍生品业务表现亮眼。' },
    { icon: CirclePlusFilled, text: '国际化步伐加快，吸引更多全球企业来港上市。' }
  ],
  cons: [
    { icon: RemoveFilled, text: '新股上市数量虽提升但仍低于高峰期。' },
    { icon: RemoveFilled, text: '全球经济与地缘风险依然存在。' },
    { icon: RemoveFilled, text: '监管政策变化带来持续合规压力。' }
  ],
  valuationA: {
    desc: '假设以当前股价（400港币）计算的自由现金流增长：',
    list: [
      { label: '未来5年FCF增长', value: '12%' },
  ...
  valuationB: {
    desc: '假设未来5年自由现金流增长持续提升：',
    list: [
      { label: '未来5年FCF增长', value: '15%' },
      { label: '终值倍数Terminal Multiple', value: '18x' },
      { label: '回报率', value: '7.5%' }
    ],
    value: '480港币',
    btn: '+20% 估值合理'
